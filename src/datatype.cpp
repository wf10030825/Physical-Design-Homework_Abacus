...
// Global CornerStitching pointer (allocated in geneCornerStitch)
CornerStitching* g_corner_stitching = nullptr;
...
// - Unit ���
prec unitResistanceName = 1; // ! def lef �Ҭ� ohm

// - Layer
prec default_layer_UnitNomResistance = 0.01; // ! def lef �Ҭ� ohm
...
// - VIA
prec default_VIA_UnitNomResistance = 1; // ! def lef �Ҭ� ohm
...
// todo : 0711
prec default_via_RDL_UnitNomResistance = 0.0001; // ! def lef �Ҭ� ohm
// todo : 0326|0.0001

// - Pin
// FPOS default_Pin_W_H = FPOS(3000., 3000.); /// For plot(�p��ɷ����@���I)
// FPOS default_Pin_W_H = FPOS(1, 1) * AMP_PARA; /// For plot(�p��ɷ����@���I)
...
// - Constant
prec default_dbu_per_micron = 1000; // ! all def coor �n / dbu_per_micron , lef ����
...
string output_dir = "";
string input_def_pl = ""; /// ���wintput def or pl
// string DATE = "";
bool read_tf = false;  /// �_��case (PA_series)
bool read_aux = false; /// bookshelf
prec aux_scale = 1.;

// - GP mode
bool fence_mode = false; // ! �N��S�}�]�� DEAFULT FENCE
bool IR_mode = true;
bool HRH_mode = false;
...
prec target_density = 1; // 1 0.65 0.429 0.98 // ! ���魱�n�Q�βv (filler�|���target_density)
...
// - Constant
prec dbu_per_micron = default_dbu_per_micron; // ! all def coor �n / dbu_per_micron , lef ����

// - Chip info
FPOS chip_lb = FPOS(PREC_MAX, PREC_MAX), chip_ur = FPOS(PREC_MIN, PREC_MIN); // @ default
FPOS chip_W_H;
prec chip_area = 0;
prec die_lb_x = PREC_MAX;
prec die_lb_y = PREC_MAX;
prec die_ur_x = 0;
prec die_ur_y = 0;
...
prec dim_M_Inv = 1. / default_dim_M; // ! �@�w�n�[1.
...
// - Power Mesh
VIA* via_RDL = nullptr; // ? rail layer �� �Y��VIA /// PA_series
